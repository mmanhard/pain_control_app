...
class Settings extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      new_password_1: '',
      new_password_2: '',
      first_name: props.userInfo?.first_name ? props.userInfo.first_name : '',
      last_name: props?.userInfo?.last_name ? props.userInfo.last_name : '',
      phone: Utils.formatPhoneInput(props?.userInfo?.phone),
      birthday: Utils.formatDateInput(props?.userInfo?.birthday),
      hometown: props?.userInfo?.hometown ? props.userInfo.hometown : '',
